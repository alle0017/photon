...
export abstract class Component {
      static toString(tree: Tree[]): string;
      dispose(): void;
      onMounted(eventHandler: () => void): Component;
}
...
export const GApp: {
      /**
       * Used to register plugins. Plugins are libraries that exposes a function that 
       * register components or add functionalities to the GApp object
       */
       ...
       * #### Note, if you want to register a function generated by another function 
       * (like useLifecycle ones), you need to explicity pass a name
       * @example
       * ```javascript
